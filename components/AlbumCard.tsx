      ...
      <div className={classNames("", className)} id={id}>
        <Link href={`/photobook/${slug.toString()}`} passHref>
          <div className="relative ">
            <div className="absolute text-4xl text-codewhite dark:text-codewhite bg-black bg-opacity-40 cursor-pointer inset-0 z-10 text-center flex flex-col items-center justify-center opacity-0 hover:opacity-100 bg-opacity-90 duration-300">
              <h4>
